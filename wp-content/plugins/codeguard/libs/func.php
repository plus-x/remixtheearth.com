    ...
    */
	...
	if ( ! function_exists( 'cg_get_space_count' )) {
		function cg_get_space_count() {
			...
			echo '<div class="analyze-content" style="margin-top:20px; float: left; background: #FFF7CF; padding: 10px; border: 1px solid #ddd;"><p>';
			
			echo ''.__( "Your site has","codeguard").' <span style="color:#222; font-weight:800; ">('.$post_count.')</span> '.__( "posts","codeguard").',  <span style="color:#222; font-weight:800;">('.$plugin_count.')</span> '.__( "plugins","codeguard").', ';
			
			echo ''.__( "and the total WordPress file content size is","codeguard").' <span style="color:#222; font-weight:800;">(' . cg_format_size( cg_folder_size( ABSPATH ) ) .')</span>.';
			
			echo '<div style="color:#222; font-weight:400; margin-top:20px; margin-bottom:10px;">'.__( "We have analyzed your content and believe your site would be better served by our SFTP + MySQL database backup solution, rather than the plugin. Please see this support article <a href='https://codeguard.zendesk.com/hc/en-us/articles/115000581066--How-To-Add-A-Website' target='_blank'>video-tutorial</a> for adding your website or contact support <a href='https://www.codeguard.com/support/'>https://www.codeguard.com/support/</a> if you need additional assistance.","codeguard").' </div>';    
